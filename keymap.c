 ...
 * |------+------+------+------+------+------|                    |------+------+------+------+------+------|
 * |CtrlT |   A  |   S  |   D  |   F  |   G  |                    |   H  |   J  |   K  |   L  |   ;  |  '   |
 * |------+------+------+------+------+------|                    |------+------+------+------+------+------|
 * | Shift|   Z  |   X  |   C  |   V  |   B  |                    |   N  |   M  |   ,  |   .  |   /  |Shift |
 * `-----------------------------------------/                    \-----------------------------------------'
 *                   | LGUI |LOWER |ENTER | /                      \  |SPACE |RAISE | CTRL |
 *                   |      |      |      |/                        \ |      |      |      |
 *                   `---------------------                           '--------------------'
 */  
  ...
  //|---------+---------+---------+---------+---------+---------|         |---------+---------+---------+---------+---------+---------|
                                    KC_LGUI,  LOWER,   KC_ALENT,             KC_SPC,   RAISE,    KC_LCTL
  //                              `-----------------------------'          `-----------------------------'
  ),
/* LOWER
 * ,-----------------------------------------.                    ,-----------------------------------------.
 ...
 * |------+------+------+------+------+------|                    |------+------+------+------+------+------|
 * | CAPS |      |      |      | PGUP |PGDWN |                    | left | down |  up  |right | HOME | END  |
 * |------+------+------+------+------+------|                    |------+------+------+------+------+------|
 ...
 */
 ...
 //|---------+---------+---------+---------+---------+---------|         |---------+---------+---------+---------+---------+---------|
    KC_CAPS,  KC_XXXXX, KC_XXXXX, KC_XXXXX,  KC_PGUP,  KC_PGDN,            KC_LEFT,  KC_DOWN,   KC_UP,   KC_RIGHT,  KC_HOME,  KC_END,
 //|---------+---------+---------+---------+---------+---------|         |---------+---------+---------+---------+---------+---------|
 ...
 * |  ~   |   !  |   @  |   #  |   $  |   %  |                    |   ^  |   &  |   *  |   (  |   )  |  DEL |
 * |------+------+------+------+------+------|                    |------+------+------+------+------+------|
 * | CAPS |RCT1ST|RCT2ND|RCT3RD|RCT4TH|      |                    |   +  |   =  |   |  |   {  |   }  |VOLUP |
 * |------+------+------+------+------+------|                    |------+------+------+------+------+------|
 * | CTRL |RCTLFT|RCTRGT|RCTCNT|RCTFLL|      |                    |   -  |   _  |   \  |   [  |   ]  |VOLDWN|
 * `-----------------------------------------/                    \-----------------------------------------'
 *                   | LGUI |LOWER |ENTER | /                      \  |SPACE |RAISE | CTRL |
 *                   |      |      |      |/                        \ |      |      |      |
 *                   `---------------------                           '--------------------'
 */
  ...
  //|---------+---------+---------+---------+---------+---------|         |---------+---------+---------+---------+---------+---------|
     KC_CAPS,   RECT1ST,  RECT2ND,  RECT3RD,  RECT4TH, KC_XXXXX,            KC_PLUS,  KC_EQL,   KC_PIPE,  KC_LCBR,  KC_RCBR,  KC_KB_VOLUME_UP,
  //|---------+---------+---------+---------+---------+---------|         |---------+---------+---------+---------+---------+---------|
     KC_LCTL,  RECTLFT,  RECTRGT,   RECTCNT,  RECTFLL, KC_XXXXX,            KC_MINS,  KC_UNDS,  KC_BSLS,  KC_LBRC,  KC_RBRC,  KC_KB_VOLUME_DOWN,
  //|---------+---------+---------+---------+---------+---------|         |---------+---------+---------+---------+---------+---------|
                                   KC_LGUI,  LOWER,   KC_ALENT,             KC_SPC,   RAISE,    KC_LCTL
  //                              `-----------------------------'          `-----------------------------'
  ),
